    ...
    <footer className="mt-16 border-t bg-foreground text-background">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_1fr]">
          <div><div className="inline-flex items-center gap-2.5 text-lg font-bold"><span className="grid size-12 place-items-center rounded-xl bg-background p-1"><BrandLogo className="size-10" /></span>{settings.brandName}</div><h2 className="mt-6 max-w-md text-2xl font-bold tracking-tight">Sudah Kebayang Liburannya? Saatnya Tentukan Perjalanannya.</h2><Button asChild className="mt-5"><Link href="/trips">Jelajahi Paket Travel<ArrowRight className="size-4" aria-hidden="true" /></Link></Button></div>
