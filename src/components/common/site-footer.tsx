  ...
  return (
    <footer className="mt-16 border-t bg-foreground text-background">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-background/15 pt-6 text-xs text-background/60 sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} {settings.brandName}. {settings.footerText ?? "Semua hak dilindungi."}</p><p>Perjalanan yang jelas, dari pilihan sampai keberangkatan.</p></div>
      </div>
    </footer>
  );
}
