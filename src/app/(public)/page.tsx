...
export const metadata: Metadata = createPublicMetadata({
  ...
  description:
    "Temukan paket perjalanan, destinasi, aktivitas, promo, dan inspirasi liburan pilihan dalam satu tempat.",
  path: "/",
});
    ...
    <>
      <section className="relative overflow-hidden border-b">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:py-24">
          ...
          <div className="relative"><PublicImage path={homepage.heroImagePath ?? popularTrips[0]?.imagePath ?? null} alt="Traveler menikmati destinasi pilihan" priority sizes="(max-width: 640px) calc(100vw - 2rem), (max-width: 1024px) calc(100vw - 3rem), 45vw" className="aspect-[4/5] rounded-[2rem] border shadow-2xl sm:aspect-[5/4] lg:aspect-[4/5]" /><div className="absolute -bottom-4 -left-3 max-w-56 rounded-2xl border bg-background/95 p-4 shadow-xl backdrop-blur sm:-left-6"><p className="text-sm font-semibold">Dikurasi untukmu</p><p className="mt-1 text-xs leading-5 text-muted-foreground">Itinerary, pengalaman, dan harga bisa kamu pelajari sebelum memesan.</p></div></div>
        </div>
      </section>
