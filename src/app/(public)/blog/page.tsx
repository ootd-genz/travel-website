...
export const metadata: Metadata = { title: "Blog & Inspirasi Perjalanan", description: "Baca tips persiapan, panduan destinasi, dan inspirasi untuk perjalanan berikutnya." };
...
export default async function BlogPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  const { blogPosts } = await getPublicCatalog();
