...
import { getPublicTripTypes } from "@/lib/public/content";
import { createPublicMetadata } from "@/lib/seo";

export const metadata: Metadata = createPublicMetadata({
  title: "Trip Types",
  description:
    "Pilih gaya perjalanan yang paling cocok untukmu, dari petualangan hingga liburan santai.",
  path: "/trip-types",
});

export default async function TripTypesPage() {
  const tripTypes = await getPublicTripTypes();
